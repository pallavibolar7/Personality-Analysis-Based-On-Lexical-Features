...
# Read data from file
with open('C:\\Users\\Pallavi PC\\Documents\\project1\\data\\essays.csv', encoding='latin-1') as f:
    i = 0
    for row in f:
        entry = []
        for j in range(5):
...
l = []
with open("C:\\Users\\Pallavi PC\\Documents\\project1\\data\\w2v_features.txt") as f:
    contents = f.read();
